...
// Built artifact for mod_livesession/embed. Moodle serves AMD modules from amd/build,
// so this file must exist for the plugin to work. Do not edit it by hand - change
// amd/src/embed.js and regenerate with `grunt amd` from the Moodle root.

define('mod_livesession/embed', ['core/ajax', 'core/str', 'core/log'], function(Ajax, Str, Log) {
    var getString = Str.getString;
     ...
     * @returns {void}
     */
    const init = (cmid, rootId, buttonId, statusId, counterId, frameId, stageId) => {
