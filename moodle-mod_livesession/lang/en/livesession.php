...
$string['settings:sdkurl_desc'] = 'Leave blank unless the meeting panel cannot load the SDK. Blank means the plugin tries the known Zoom CDN paths in turn. To pin one exactly, enter the full URL; <code>{version}</code> is replaced with the version above. For example <code>https://source.zoom.us/zoom-meeting-embedded-{version}.min.js</code>.';
