...
$string['settings:sdkheading_desc'] = 'A separate <strong>Meeting SDK</strong> app, used only to sign the token that lets a browser into the meeting. Without it the meeting cannot be embedded in the page.';
$string['settings:sdkclientid'] = 'SDK client ID';
$string['settings:sdkclientid_desc'] = 'From the Meeting SDK app\'s credentials page.';
$string['settings:sdkclientsecret'] = 'SDK client secret';
$string['settings:sdkclientsecret_desc'] = 'From the Meeting SDK app\'s credentials page. Never sent to the browser - it only signs the short-lived join token.';
$string['settings:sdkversion'] = 'Meeting SDK version';
$string['settings:sdkversion_desc'] = 'The Meeting SDK release loaded in the browser. Zoom only supports clients within a few releases of the current one, so keep this reasonably current.';
...
$string['error:syncfailed'] = 'The Zoom meeting for this session could not be created or updated: {$a} Save the activity again to retry.';
